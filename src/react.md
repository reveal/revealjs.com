...
Instead of editing/manipulating the `index.html` by hand, you can add and initialize reveal in a Javascript/Typescript source file like `main.tsx` or `app.tsx`. 
